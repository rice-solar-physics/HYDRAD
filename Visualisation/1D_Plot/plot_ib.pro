...
szFilename = STRCOMPRESS( STRING( 'profile', profile_no, '.phy' ), /REMOVE_ALL )
...
szFilename = STRCOMPRESS( STRING( 'profile', profile_no, '.ine' ), /REMOVE_ALL )
...
; Plot the data
PLOT, Teq, I1eq, linestyle=1, th=2, xrange=[4.0,7.0], yrange=[0.0,1.0], xth=2, yth=2, xtitle='Log!l10!n T (K)', ytitle='He Population Fraction', charsize=2, charth=2
